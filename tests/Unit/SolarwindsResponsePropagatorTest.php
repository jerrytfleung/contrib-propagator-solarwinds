...
namespace OpenTelemetry\Tests\Propagation\Solarwinds\Unit;
...
use OpenTelemetry\Contrib\Propagation\Solarwinds\SolarwindsResponsePropagator;
use OpenTelemetry\SDK\Trace\Span;
use PHPUnit\Framework\TestCase;

class SolarwindsResponsePropagatorTest extends TestCase
{
    ...
    {
        $propagator = new SolarwindsResponsePropagator();
        $this->assertSame($propagator->fields(), [SolarwindsResponsePropagator::X_TRACE, SolarwindsResponsePropagator::X_TRACE_OPTIONS_RESPONSE]);
    }
    ...
    {
        $carrier = [];
        (new SolarwindsResponsePropagator())->inject(
            $carrier,
            null,
        ...
        $this->assertSame(
            [SolarwindsResponsePropagator::X_TRACE => self::TRACERESPONSE_HEADER_SAMPLED],
            $carrier
        );
    }
    ...
    public function test_inject_valid_not_sampled_trace_id()
    {
        ...
        $this->assertSame(
            [SolarwindsResponsePropagator::X_TRACE => self::TRACERESPONSE_HEADER_NOT_SAMPLED],
            $carrier
        );
    }
